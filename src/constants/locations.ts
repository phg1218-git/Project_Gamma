/**
 * 이어줌 (Connecting) — Korean Location Data
 *
 * Province (시/도) → District (구/군) mapping.
 * Used for companyLocation, residenceLocation, hometownLocation.
 * Stored as "province|district" format in DB.
 */
